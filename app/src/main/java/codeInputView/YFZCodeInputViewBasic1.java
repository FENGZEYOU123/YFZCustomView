...
public class YFZCodeInputViewBasic1 extends YFZCodeInputViewBasic {
    public YFZCodeInputViewBasic1(Context context) {
        super(context);
        initial(context);
    }
    public YFZCodeInputViewBasic1(Context context, AttributeSet attrs) {
        super(context, attrs);
        initial(context);
    }
    public YFZCodeInputViewBasic1(Context context, AttributeSet attrs, int defStyleAttr) {
